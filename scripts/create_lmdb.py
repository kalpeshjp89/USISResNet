...
# configurations
img_folder = '/media/mllab/Data/Kalpesh/DIV2K_train_HR_sub/'  # glob matching pattern
lmdb_save_path = '/media/mllab/Data/Kalpesh/DIV2K_train_HR_sub.lmdb'  # must end with .lmdb
