...
class NT_Model(BaseModel):
    def __init__(self, opt):
        ...
        self.netG = networks.define_G3(opt).to(self.device)  # G1
        if self.is_train:
    ...
    def optimize_parameters(self, step):
        ...
        log_d_total = 0
        self.HR_Encoded = self.netD(self.var_H)
        self.SR_Encoded = self.netD(self.SR.detach())
        
        g1 = self.l_gan_w * self.cri_gan(self.SR_Encoded, False)
        g2 = self.l_gan_w * self.cri_gan(self.HR_Encoded, True)
